...
<head>
    ...
    <link rel="stylesheet" href='{{ url("css/homePageLogin.css")}}'>
    <script src='{{ url("js/homePageLogin.js")}}' defer></script>
    ...
    <div class='div_anteprima'>
        <div class='contenitore_totale_modale'>
            ...
            <div class='commenti_modale'>
                <form action="{{route('inserisciCommento')}}" name="commenti" method="POST" class='hidden'>
                @csrf
