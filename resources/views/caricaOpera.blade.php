...
<head>
    ...
    <link rel="stylesheet" href='{{ url("css/caricaOpera.css")}}'>
    <script src='{{ url("js/caricaOpera.js")}}' defer></script>
...
<main>
    ...
    <form action="{{route('carica')}}" name="form_dati_opera" method="POST" enctype='multipart/form-data'>
    @csrf  
